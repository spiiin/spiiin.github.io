...
Хотя бы одна пуля из дробовика в `Team Fortress 2` всегда попадает в цель, чтобы им можно было надёжно пользоваться в случае, когда нужно нанести хотя бы одну единицу урона.
